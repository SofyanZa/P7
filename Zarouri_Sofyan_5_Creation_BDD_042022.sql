...
CREATE TABLE IF NOT EXISTS `OCPizza`.`Pizza_Commande` (
  ...
  INDEX `fk_Pizza_has_Commande_Commande1_idx` (`commande_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `OCPizza`.`Commande_Pizzeria` (
  ...
  INDEX `fk_Commande_has_Pizzeria_Commande1_idx` (`commande_id` ASC) VISIBLE,
